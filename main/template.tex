...
SCOB - Do świtu  jest dobrym przykładem zastosowania pustych linijek w tekście, aby dopisać chwyty bez tekstu. W obu przypadkach dobrze, jeśli liczba linijek w chwytach jest taka sama jak liczba linijek w tekście.